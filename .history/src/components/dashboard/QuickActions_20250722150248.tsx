                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {actions.map((action) => (
                        <button
                            ...
                            className={`${action.color} text-white p-4 rounded-lg transition-all duration-200 text-left group hover:shadow-md transform hover:scale-105`}
                        >
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="flex items-center">
                        ...
                        <div className="flex-1">
                            <h4 className="text-sm font-medium text-blue-900">AI Providers Ready</h4>
                            <p className="text-xs text-blue-700 mt-1">
                                Gemini (primary) and Claude (fallback) are active and ready for HIPAA-compliant note generation.
                            </p>
                        </div>
                        <div className="flex space-x-1">
                            <div className="h-2 w-2 bg-green-500 rounded-full" title="Gemini Active"></div>
                            <div className="h-2 w-2 bg-green-500 rounded-full" title="Claude Active"></div>
                        </div>
                    </div>
                </div>
            </div>
